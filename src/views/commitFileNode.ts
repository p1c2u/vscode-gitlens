...
import { CommitFormatter, getGitStatusIcon, GitBranch, GitCommitType, GitLogCommit, GitUri, ICommitFormatOptions, IGitStatusFile, IStatusFormatOptions, StatusFileFormatter } from '../gitService';
